...
static void
arpscan(char *netname, const char *ipaddr, const char *netmask, char *device, long timeout)
{
...
static void
handle_network(const char *interface, int qaddr, int qmask, int qclnt, int qport, int qscan, long timeout)
{
...
{
	fprintf(stderr, "Usage: netcheck -i <interface> <option>\n");
